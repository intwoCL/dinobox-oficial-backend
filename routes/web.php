...
Route::middleware('auth.user')->group( function () {
  ...
  // {SALA}
  Route::resource('sala','Sala\SalaController',['except'=>['create','destroy','show']]);
  Route::post('sala/publica','Sala\SalaController@entrarPassword')->name('sala.entrar.password');
  Route::post('sala/oculta','Sala\SalaController@entrarCodigo')->name('sala.entrar.codigo');
