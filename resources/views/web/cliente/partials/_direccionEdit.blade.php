<form action="{{ route('profile.direcciones.update', $d->id) }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control form-control-border" name="calle" id="calle" autocomplete="new-street" value="{{ $d->calle }}" placeholder="Calle" required>
    </div>
    <div class="col-sm-5">
      <input type="number" class="form-control form-control-border" name="numero" id="numero" autocomplete="new-number" value="{{ $d->numero }}" placeholder="Número">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="input-group col-sm-8">
      <input type="number" class="form-control form-control-border" name="telefono" id="telefono" autocomplete="new-telephone" maxlength="9" placeholder="Ingrese su teléfono aqui..." pattern="[0-9]{9}" title="Formato de 9 digitos" value="{{ $d->telefono }}">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="input-group col-sm-10">
      <div class="custom-control custom-switch">
        <input type="checkbox" class="custom-control-input" id="customSwitch1" {{ $d->favorito ? 'checked' : '' }}>
