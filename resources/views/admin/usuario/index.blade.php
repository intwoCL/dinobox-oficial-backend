    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('admin.usuario.indexDelete') }}" class="btn btn-dark float-left btn-sm"> Colaboradores eliminados</a>
          <a href="{{ route('admin.usuario.create') }}" class="btn btn-success float-right btn-sm"> Nuevo</a>
        </div>
